 ...
 *
 * @author xingtian
 * @version $Id: JDBCIterator.java,v 0.1 2014年12月8日 下午9:31:46 xingtian Exp $
 */
public class JDBCIterator {
    ...
    protected static class JDBCUnit {
        ...
        public String getNextSQL(int seq) {
            ...
            String currentSql = sql.replace(JDBCSplitter.CONDITIONS, column + " >= " + tempStart + " AND " + column + " < " + tempEnd);
        ...
        public String toString() {
            return "JDBCUnit{" + "startCursor=" + startCursor + ", endCursor=" + endCursor + ", start=" + start + ", end=" + end + ", step=" + step
                    + ", parallelism=" + parallelism + ", middle=" + middle + ", column='" + column + '\'' + ", sql='" + sql + '\'' + '}';
        }
    }
